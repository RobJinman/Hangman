...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Dec 1 11:13:26 2013
# Project:  hangman.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hangman1.0.0/ && $(COPY_FILE) --parents Game.hpp GameLogic.hpp GameState.hpp GameUi.hpp Hangman.hpp KvpParser.hpp QtGameWindow.hpp QtUi.hpp Strings.hpp TextDisplay.hpp TextHangman.hpp TextUi.hpp .tmp/hangman1.0.0/ && $(COPY_FILE) --parents Game.cpp GameLogic.cpp Hangman.cpp KvpParser.cpp main.cpp QtGameWindow.cpp QtUi.cpp Strings.cpp TextDisplay.cpp TextHangman.cpp TextUi.cpp .tmp/hangman1.0.0/ && (cd `dirname .tmp/hangman1.0.0` && $(TAR) hangman1.0.0.tar hangman1.0.0 && $(COMPRESS) hangman1.0.0.tar) && $(MOVE) `dirname .tmp/hangman1.0.0`/hangman1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hangman1.0.0
...
compiler_moc_header_make_all: moc_QtGameWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_QtGameWindow.cpp
moc_QtGameWindow.cpp: QtGameWindow.hpp
...
QtGameWindow.o: QtGameWindow.cpp QtGameWindow.hpp
