#############################################################################
# Makefile for building: hangmuz
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Dec 10 19:11:22 2013
# Project:  hangmuz.linux.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile hangmuz.linux.pro
#############################################################################
...
CXXFLAGS      = -std=c++0x -O2 -Wall -W -D_REENTRANT $(DEFINES)
...
Makefile: hangmuz.linux.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile hangmuz.linux.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/hangmuz1.0.0 || $(MKDIR) .tmp/hangmuz1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/hangmuz1.0.0/ && $(COPY_FILE) --parents Game.hpp GameLogic.hpp GameState.hpp GameUi.hpp Hangman.hpp KvpParser.hpp QtApplication.hpp QtGameWindow.hpp QtGuess.hpp QtHangman.hpp QtLetters.hpp QtUi.hpp Strings.hpp TextDisplay.hpp TextHangman.hpp TextUi.hpp .tmp/hangmuz1.0.0/ && $(COPY_FILE) --parents Game.cpp GameLogic.cpp Hangman.cpp KvpParser.cpp main.cpp QtApplication.cpp QtGameWindow.cpp QtGuess.cpp QtHangman.cpp QtLetters.cpp QtUi.cpp Strings.cpp TextDisplay.cpp TextHangman.cpp TextUi.cpp .tmp/hangmuz1.0.0/ && (cd `dirname .tmp/hangmuz1.0.0` && $(TAR) hangmuz1.0.0.tar hangmuz1.0.0 && $(COMPRESS) hangmuz1.0.0.tar) && $(MOVE) `dirname .tmp/hangmuz1.0.0`/hangmuz1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/hangmuz1.0.0
